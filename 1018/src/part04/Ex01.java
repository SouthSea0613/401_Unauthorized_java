...
class Person implements Comparable<Person>{
	...
	public int compareTo(Person p) {
		// TODO Auto-generated method stub
		// Person 타입의 name의 길이를 기준으로 정렬 및 같은길이 비허용
...
public class Ex01 {
	public static void main(String[] args) {
		...
		tree_set.add(new Person("남남해", 7));	// #1
		tree_set.add(new Person("남해해", 7));	// #1과 이름길이 동일
		tree_set.add(new Person("남남해해", 13));	
		tree_set.add(new Person("남남남해해", 99));
		tree_set.add(new Person("남해해해해해", 1));
