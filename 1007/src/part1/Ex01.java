...
public class Ex01 {
	public static void main(String[] args) {
		System.out.println("boxVolume(1): "+box(1)); //가로:1 나머지 기본 값 : 1
		System.out.println("boxVolume(1,2): "+box(1,2)); //가로:1, 세로:2 나머지 기본 값 : 1
		System.out.println("boxVolume(1,2,3): "+box(1,2,3)); //가로:1, 세로:2, 높이:3
	}
